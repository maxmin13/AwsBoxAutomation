...
* *Console* — live viewer for the app's own log file
...
. Open *My Account* and work through the security hardening cards, then create an IAM user
...
| *My Account*
| Root security hardening, IAM user creation, billing/anomaly alerts — see link:docs/ACCOUNT_PAGE.md[docs/ACCOUNT_PAGE.md]
...
* link:docs/ACCOUNT_PAGE.md[docs/ACCOUNT_PAGE.md] — how the Account page works
